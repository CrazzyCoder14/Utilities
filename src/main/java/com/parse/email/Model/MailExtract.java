...
public class MailExtract{
    ...
    public static void main(String[] args) throws MessagingException, IOException {
        ...
        //  store.connect("outlook.office365.com","ankit.ramtriya@iiitb.org", "*******");
...
//          Message[] messages = folder.getMessages();
          SearchTerm searchterm1 = new FromTerm(new InternetAddress("ramtriyaankit@gmail.com"));
            ...
            if(contentType.contains("multipart"))
            {
            	...
            	for (int i1 = 0; i1 < multiPart.getCount(); i1++) {
            	    ...
            	    if (Part.ATTACHMENT.equalsIgnoreCase(part.getDisposition())) {
            	    	...
            	    	String destFilePath = "/home/ankit/Desktop/" + part.getFileName();
